...
export default function SearchScreen() {
  ...
  const fetchNomePrateleiras = async () => {
    try {
      const response = await axios.get('https://matafome-api.whiteglacier-7456d729.brazilsouth.azurecontainerapps.io/api/empresas/{id}/prateleiras'); // Substitua pela URL real
