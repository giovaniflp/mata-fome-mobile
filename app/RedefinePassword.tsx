        ...
        <ScrollView className="bg-white">
            <View className='h-full bg-white flex justify-between'>
                <View className="mt-40">
                    ...
                    <View className="flex items-center gap-5">
                        <View>
                            ...
                            <Input className="w-80 bg-white text-black" placeholder="Digite sua nova senha" secureTextEntry></Input>
                        </View>
                        <View>
                            <H6 className="text-black">Confirme sua senha</H6>
                            <Input className="w-80 bg-white text-black" placeholder="Confirme a senha digitada anteriormente" secureTextEntry></Input>
                        </View>
                    </View>
                </View>
                <View className="flex items-center mt-48">
                    ...
                    }} className='w-60 bg-orange-500 rounded-3xl text-white'>Redefinir senha</Button>
                </View>
            </View>
        </ScrollView>
    )
